...
import os
from PopGen.settings import BASE_DIR#,MEDIA_ROOT
from django.contrib.auth.models import Permission, User,UserManager

from django.core.urlresolvers import reverse, reverse_lazy
def user_directory_path(instance, filename):
    #directory = os.path.join(instance.user.username,instance.job_name)
    #try:
    #    os.stat(directory)
    #except:
    #    os.mkdir(directory) 
...
class JobFinal(models.Model):
    ...
    synthesize2=models.BooleanField('Synthesize',help_text='',default=True)
    ...
    geo = models.CharField('Groupquaters Entity Name',max_length=50,help_text='')
    ...
    #location
        ...
        #geo_corr_mapping
    geo_to_sample = models.FileField('geo to Sample',upload_to=user_directory_path, blank=True, null=True,help_text='e.g. geo_sample_mapping.csv')
    region_to_sample = models.FileField('region to Sample',upload_to=user_directory_path, blank=True, null=True,help_text='e.g. region_sample_mapping.csv')
    region_to_geo = models.FileField('region to Geo',upload_to=user_directory_path, blank=True, null=True,help_text='e.g. region_geo_mapping.csv')
    #sample

    sample_household = models.FileField('Sample Household',upload_to=user_directory_path, blank=True, null=True,help_text='e.g. household_sample.csv')
    sample_person = models.FileField('Sample Person',upload_to=user_directory_path, blank=True, null=True,help_text='e.g. person_sample.csv')
    sample_groupquarter = models.FileField('Sample Groupquarter',upload_to=user_directory_path, blank=True, null=True,help_text='e.g. groupquarters_sample.csv')

    geo_household_files = models.FileField('Geo Household Marginals', upload_to=user_directory_path, blank=True, null=True,help_text='e.g. household_marginals.csv')
    geo_person_files = models.FileField('Geo Person Marginals', upload_to=user_directory_path, blank=True, null=True,help_text='e.g. person_marginals.csv')
    geo_groupquarter_files = models.FileField('Geo Groupquarter Marginals', upload_to=user_directory_path, blank=True, null=True,help_text='e.g. groupquarters_marginals.csv')

    region_household_files = models.FileField('Region Household Marginals', upload_to=user_directory_path, blank=True, null=True,help_text='e.g. region_household_marginals.csv')
    region_person_files = models.FileField('Region Person Marginals', upload_to=user_directory_path, blank=True, null=True,help_text='e.g. region_person_marginals.csv')
    region_groupquarter_files = models.FileField('Region Groupquarter Marginals', upload_to=user_directory_path, blank=True, null=True,help_text='e.g. region_groupquarters_marginals.csv')
    #scenario
    ...
    region_groupquarter= models.CharField('Control Variable Region Groupquarter', max_length=50, help_text='e.g.  [gqrtotals]')
    ...
    geo_groupquarter= models.CharField('Control Variable Geo Groupquarter', max_length=50, help_text='e.g.  [gqtotals, gqtype]')
