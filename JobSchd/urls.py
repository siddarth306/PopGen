...
urlpatterns = [
    ...
    url(r'^jobform_final/create/$', views.createJob, name='jobform_final'),
    url(r'^jobform_final/(?P<pk>\d+)/update/$', views.updateJob, name='jobform_final_update'),
    url(r'^jobform_final/(?P<pk>\d+)/delete/$', views.deleteJob, name='jobform_final_delete'),
